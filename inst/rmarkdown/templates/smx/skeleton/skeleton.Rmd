...
# Specify the synaflokkur using the id and the gear using the gid. Below
#  applies to SMH.
res <- import_smx(con, id = 35, gid = c(77, 78))
...
munge_for_smxapp(res, cruise = c("TL2-2018"))
```
